...
public final class SimpleGUI {
    ...
    public SimpleGUI(Controller controller) {
        ...
        p.add(textf, BorderLayout.NORTH);
        JTextArea texta= new JTextArea();
        p.add(texta, BorderLayout.CENTER);
        ...
        print.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) { 
                String f = textf.getText();
                SimpleGUI.this.controller.setNextStringToPrint(f);
        ...
        showHistory.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                String text = "";
                List<String> history;
                for (String string : SimpleGUI.this.controller.getPrintedStringsHistory()) {
                    text = text + '\n' + string;
                }            
                texta.setText(text.toString());
            }
        });
    ...
    public static void main(final String[] args) {
        SimpleGUI g = new SimpleGUI(new ControllerImpl());
        g.display();
    }
